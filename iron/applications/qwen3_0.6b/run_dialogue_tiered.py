...
"""Stream a chat with Qwen3-0.6B on NPU using the tiered seq-len dispatch.

Usage:
    python3 run_dialogue_tiered.py --prompt "你好，请介绍一下MoE" --max-tokens 200

The model prefill + decode is token-by-token on the NPU (tiered 256/512), with
streaming decode to stdout and a TPOT/TPS summary at the end.
"""
