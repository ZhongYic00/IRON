...
//     cos: (head_dim,) bf16 — cos table for current position (duplicated halves,
//          HF rotate_half format: cos[i + head_dim/2] == cos[i])
//     sin: (head_dim,) bf16 — sin table for current position (duplicated halves)
//
